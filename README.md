About kiwipy-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kiwipy-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=503&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kiwipy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kiwipy` can be installed with `conda`:
...
```
mamba install kiwipy
```

It is possible to list all of the versions of `kiwipy` available on your platform with `conda`:
...
```
mamba search kiwipy --channel conda-forge
```
...
mamba repoquery search kiwipy --channel conda-forge

# List packages depending on `kiwipy`:
mamba repoquery whoneeds kiwipy --channel conda-forge

# List dependencies of `kiwipy`:
mamba repoquery depends kiwipy --channel conda-forge
```
